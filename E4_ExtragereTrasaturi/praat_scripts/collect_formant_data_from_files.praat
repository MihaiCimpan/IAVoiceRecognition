...
form Analyze formant values from labeled segments in files
	...
	text resultfile C:\_facultate\IA\audio_input\formantresults.txt
...
titleline$ = "Filename	Timestamp	 F1 (Hz)	F2 (Hz)	F3 (Hz) F4(Hz) 'newline$'"
...
for ifile to numberOfFiles
    ...
    for i to (tmax-tmin)/0.01
		...
		f1 = Get value at time... 1 timestamp Hertz Linear
		f2 = Get value at time... 2 timestamp Hertz Linear
		f3 = Get value at time... 3 timestamp Hertz Linear
        f4 = Get value at time... 4 timestamp Hertz Linear
		# Save result to text file:
		resultline$ = "'soundname$'	'timestamp'		'f1'	'f2'	'f3' 'f4' 'newline$'"
